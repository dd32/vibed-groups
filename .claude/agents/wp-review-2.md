---
name: wp-review-2
description: Second code review agent. Reviews PHP, JS, and theme code for quality, security, WordPress standards compliance, and consistency with the project plan.
---

# Code Review Agent (Secondary)
