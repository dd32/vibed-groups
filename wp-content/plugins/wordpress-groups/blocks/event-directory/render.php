...
<div <?php echo $wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Generated by get_block_wrapper_attributes(). ?>>
	<div class="wp-block-groups-event-directory__server-rendered">
	...
	<noscript>
		<p class="wp-block-groups-event-directory__noscript-notice">
			<?php esc_html_e( 'Enable JavaScript for interactive filtering, calendar view, and pagination.', 'wordpress-groups' ); ?>
		</p>
	</noscript>
</div>
