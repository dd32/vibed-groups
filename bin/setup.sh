...
npx wp-env run cli wp eval-file seed-data.php --url="$MELBOURNE_URL" 2>/dev/null || true
...
npx wp-env run cli wp eval-file seed-data-tokyo.php --url="$TOKYO_URL" 2>/dev/null || true
